...
const Zpara = (u: [number, number], v: [number, number]): [number, number] => {
...
export default function Lab4({
  ...
  useEffect(() => {
    ...
    const ItestCalc = Zmulscal(
      V,
      Zinv(Zaddscal(rf + zn, Zadd4(Zs, Zl, ZsKoCalc, ZlKoCalc))),
    );
    setItest(ItestCalc);
  ...
  const ItestPolarAngle = (180 * Math.atan2(Itest[1], Itest[0])) / Math.PI;
  const VtestPolarMag = Zabs(Vtest);
  const VtestPolarAngle = (180 * Math.atan2(Vtest[1], Vtest[0])) / Math.PI;
      ...
      <div className="lab4-card">
        ...
        <div className="lab4-diagram-wrapper">
          <div className="relative inline-block">
            <svg width="960" height="430" id="svg4628" className="lab4-svg">
              <defs id="defs4629">
                <marker
                  orient="auto"
                  refY="0"
              ...
              <g id="mainGroup" transform="translate(0,-622.36218)">
                ...
                />
                <path id="pathVertical" d="m 166.11489,770.73153 0,147.82461" />
                ...
                >
                  ...
                  />
                  <path id="path4195" d="m 178.66846,-35.7004 0,10" />
                </g>
                ...
                <path
                  ...
                  transform="matrix(3.5946193,0,0,3.5946193,37.22,546.14928)"
                />
                ...
                <text
                  ...
                  y="784.08"
                  id="textRelayRSign"
                  className="impedance-label"
                >
                  <tspan id="tspanRelayRSign" x="471.86" y="784.08">
                    R
                  </tspan>
                </text>
                ...
                <text
                  x="0"
                  y="1010.026"
                  id="textDistanceToFault"
                  className="distance-indicator"
                >
                  <tspan id="tspanDistanceToFault" x="0" y="1010.026">
                    Distance to fault =
                  </tspan>
                </text>
                ...
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspanZs" x="234.87416" y="650.91687">
                    Zs=
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspanZ0s" x="222.9436" y="685.26208">
                    Z0s=
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspanZl" x="554.9942" y="649.40161">
                    Zl=
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspanZ0l" x="544.20947" y="685.26208">
                    Z0l=
                  </tspan>
                </text>
                ...
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspan6393" x="302.78125" y="">
                    +j
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspan6405" x="586" y="881.71069">
                    +j
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspan6421" x="648" y="649.40161">
                    +j
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspan6425" x="648" y="684.72845">
                    +j
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspanjZs" y="649.40161" x="330">
                    +j
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspanjZ0s" x="330" y="684.72845">
                    +j
                  </tspan>
                </text>
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspanGeneratorV" x="100" y="729.29877">
                    V
                  </tspan>
                </text>
                ...
                <text
                  ...
                  className="impedance-label"
                >
                  <tspan id="tspan7777" x="711.51343" y="792.75458">
                    Rf=
                  </tspan>
                </text>
                <text
                ...
                >
                  <tspan id="tspan7788" x="812.03912" y="794.65839">
                    Ω
                  </tspan>
                </text>
                ...
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspan7800" x="731.47107" y="649.35229">
                    Ω
                  </tspan>
                </text>
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspan7804" x="731.47107" y="686.27222">
                    Ω
                  </tspan>
                </text>
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspan7808" x="410.42752" y="651.76007">
                    Ω
                  </tspan>
                </text>
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspan7812" x="413.62494" y="684.66705">
                    Ω
                  </tspan>
                </text>
                ...
                <text id="text7814" x="819" y="985.3064" className="unit-label">
                  <tspan id="tspan7816" x="819" y="985.3064">
                    V
                  </tspan>
                </text>
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspan7820" x="836" y="1036.5332">
                    A
                  </tspan>
                </text>
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspancopyV" x="610" y="985.3064">
                    V,
                  </tspan>
                </text>
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspancopyI" x="610" y="1036.5332">
                    A,
                  </tspan>
                </text>
                ...
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspan7824" x="390.05566" y="882.10883">
                    Ω
                  </tspan>
                </text>
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspan7828" x="675" y="882.10883">
                    Ω
                  </tspan>
                </text>
                ...
                {/* Zn labels */}
                <text id="text7838" x="150" y="827" className="unit-label">
                  <tspan id="tspan7840" x="150" y="827">
                    Ω
                  </tspan>
                </text>
                <text id="text7842" x="50" y="827" className="impedance-label">
                  <tspan id="tspan7844" x="50" y="827">
                    Zn=
                  </tspan>
                </text>
                ...
                <text
                  ...
                  className="unit-label"
                >
                  <tspan id="tspanPercentSign" x="280" y="1012">
                    %
                  </tspan>
                </text>
            ...
            <div
              ...
              style={{ top: "15.837455px", left: "265.14728px" }}
            >
            ...
            <div
              className="input-form-wrapper"
              style={{ top: "15.837455px", left: "590.34534px" }}
            >
              <InputField value={Zlr} onChange={setZlr} />
            </div>
            <div
              className="input-form-wrapper"
              style={{ top: "15.837455px", left: "664.98492px" }}
            >
              <InputField value={Zlx} onChange={setZlx} />
            </div>
            <div
              className="input-form-wrapper"
              style={{ top: "50.18264px", left: "265.14728px" }}
            >
            ...
            <div
              className="input-form-wrapper"
              style={{ top: "50.18264px", left: "590.34534px" }}
            >
              <InputField value={Zl0r} onChange={setZl0r} />
            </div>
            <div
              className="input-form-wrapper"
              style={{ top: "50.18264px", left: "664.98492px" }}
            >
              <InputField value={Zl0x} onChange={setZl0x} />
            </div>
            <div
              className="input-form-wrapper"
              style={{ top: "90.659813px", left: "40.771591px" }}
            >
              <InputField value={V} onChange={setV} />
            </div>
            <div
              className="input-form-wrapper"
              style={{ top: "155.27913px", left: "740.81744px" }}
            >
              <InputField value={rf} onChange={setRf} />
            </div>
            <div
              className="input-form-wrapper"
              style={{ top: "187.1px", left: "90px" }}
            >
              <InputField value={zn} onChange={setZn} />
            </div>
            <div
              className="input-form-wrapper"
              style={{ top: "373px", left: "115px" }}
            >
